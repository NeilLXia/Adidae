...
import { getCartDataAsync, initializeProductData } from "@reducers/cartSlice";
...
function HeaderBar() {
  ...
  return (
    <div id="header-bar" data-testid="header-bar">
      <div className="header-bar fixed w-full max-w-[390px] md:max-w-[950px] z-40 overflow-visible">
            ...
            <div className="my-auto w-[110px] flex ml-4">
              ...
              >
                <i
                  className={
                    isDarkTheme
                      ? "fa-sharp fa-solid fa-sun text-2xl text-white p-3"
                      : "fa-sharp fa-solid fa-moon text-2xl text-white p-3"
                  }
                />
              </button>
              <button
      ...
      <div className="relative overflow-x-auto header-bar w-full h-8 pt-2 text-xs italic text-center border-solid border-y-2 border-gray-100 dark:border-gray-900 bg-white dark:bg-black">
        <span className="overflow-x-auto">SITE-WIDE ANNOUNCEMENT MESSAGE!</span>
      </div>
    </div>
  );
}
